<template>
    <div class="ColToBoolNodeLayout nodes-style" :class="[{'nodes-selected': selected}, {'nodes-dbclicked': data.dbclicked}]">
        <NodeTitle node-category="compute">列转布尔值</NodeTitle>
...
<script lang="ts" setup>
    ...
    import type { ColToBoolNodeData } from '@/types/nodeTypes'


    const props = defineProps<NodeProps<ColToBoolNodeData>>()
