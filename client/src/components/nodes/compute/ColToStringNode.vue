<template>
    <div class="ColToStringNodeLayout nodes-style" :class="[{'nodes-selected': selected}, {'nodes-dbclicked': data.dbclicked}]">
        <NodeTitle node-category="compute">列转字符串</NodeTitle>
...
<script lang="ts" setup>
    ...
    import type { ColToStringNodeData } from '@/types/nodeTypes'


    const props = defineProps<NodeProps<ColToStringNodeData>>()
