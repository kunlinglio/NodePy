<template>
    <div class="ColToFloatNodeLayout nodes-style" :class="[{'nodes-selected': selected}, {'nodes-dbclicked': data.dbclicked}]">
        <NodeTitle node-category="compute">列转浮点数</NodeTitle>
...
<script lang="ts" setup>
    ...
    import type { ColToFloatNodeData } from '@/types/nodeTypes'


    const props = defineProps<NodeProps<ColToFloatNodeData>>()
